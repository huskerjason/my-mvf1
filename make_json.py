...
x = ['Max Verstappen — MultiViewer', 'Fernando Alonso — MultiViewer', 'Sergio Perez — MultiViewer',
     ...
     'Nikita Mazepin — MultiViewer', 'Data Channel — MultiViewer', 'Driver Tracker — MultiViewer']

# save those dictionaries
with open(f'{path}grid_oder.json', 'w') as json_file:
...
# print('all_dict = ' + str(player_all_dict))
